...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yonathan/ZJRemoteNotification'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yonathan' => 'yonathan@asetku.com' }
  s.source           = { :git => 'https://github.com/yonathan/ZJRemoteNotification.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'ZJRemoteNotification' => ['ZJRemoteNotification/Assets/*.png']
  # }
